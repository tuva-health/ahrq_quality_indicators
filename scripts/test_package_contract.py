...
EXPECTED_ASSET_SLUG = "ahrq-quality-indicators"
EXPECTED_VERSION_CALL = (
    "ahrq_quality_indicators.get_ahrq_quality_indicators_package_version()"
)
VERSION_MACRO = (
    ROOT / "macros" / "get_ahrq_quality_indicators_package_version.sql"
)
