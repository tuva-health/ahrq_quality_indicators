...
from {{ ref('ahrq_quality_indicators__stg_pqi_inpatient_encounter') }} as denom
inner join {{ ref('ahrq_quality_indicators__int_pqi_shared_exclusion_missing_age') }} as age
...
select
  ...
  , cast('{{ var('tuva_last_run') }}' as {{ dbt.type_timestamp() }}) as tuva_last_run
from {{ ref('ahrq_quality_indicators__stg_pqi_inpatient_encounter') }} as denom
inner join {{ ref('ahrq_quality_indicators__int_pqi_shared_exclusion_missing_gender') }} as gender
...
select
  ...
  , cast('{{ var('tuva_last_run') }}' as {{ dbt.type_timestamp() }}) as tuva_last_run
from {{ ref('ahrq_quality_indicators__stg_pqi_inpatient_encounter') }} as denom
inner join {{ ref('ahrq_quality_indicators__int_pqi_shared_exclusion_missing_dates') }} as dates
...
select
  ...
  , cast('{{ var('tuva_last_run') }}' as {{ dbt.type_timestamp() }}) as tuva_last_run
from {{ ref('ahrq_quality_indicators__stg_pqi_inpatient_encounter') }} as denom
inner join {{ ref('ahrq_quality_indicators__int_pqi_shared_exclusion_missing_primary_dx') }} as dx
...
select
  ...
  , cast('{{ var('tuva_last_run') }}' as {{ dbt.type_timestamp() }}) as tuva_last_run
from {{ ref('ahrq_quality_indicators__stg_pqi_inpatient_encounter') }} as denom
inner join {{ ref('ahrq_quality_indicators__int_pqi_shared_exclusion_transfer') }} as tx
...
select
  ...
  , cast('{{ var('tuva_last_run') }}' as {{ dbt.type_timestamp() }}) as tuva_last_run
from {{ ref('ahrq_quality_indicators__stg_pqi_inpatient_encounter') }} as denom
inner join {{ ref('ahrq_quality_indicators__int_pqi_shared_exclusion_ungroupable_drg') }} as drg
